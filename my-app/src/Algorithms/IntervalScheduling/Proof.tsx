  ...
  render() {
    return (
      <div>
        ...
        <p>Assume that our solutions are equal <i>up to a point</i> <$>r</$>, in other words: <$>i_1 = j_1, i_2 = j_2, ..., i_r = j_r</$> for some <$ math="r < k" /> (but any subsequent jobs are <i>not equal</i>). Then:</p>
        <ul>
